...
class CreateRoadClosure extends ModalComponent
{
    ...
    {
        $this->closure_types = ClosureType::class::where('status', true)->get();
    }

    #[On('update_map_shape')]
    public function updateMapShape($shape_type, $shape_data, $marker_lat = null, $marker_lng = null): void
    {
    ...
    public function saveClosure(): bool
    {
        $this->validate();
