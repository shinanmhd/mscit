    ...
    @push('scripts')
        ...
        <script>
            ...
            function createAddClosureControl(map) {
                ...
                addClosureButton.style.borderRadius = "100px";
                ...
                addClosureButton.style.padding = "0 10px";
            ...
            function createAllClosuresControl(map) {
                ...
                allClosuresButton.style.borderRadius = "100px";
                ...
                allClosuresButton.style.padding = "0 10px";
